...
pub fn runtime_and_ffi_contracts_are_cross_platform_safe_test() {
  ...
  assert string.contains(windows_job, "windows-job-v3-20260831.exe")
  assert string.contains(windows_job_bridge, "windows-job-v3-20260831.exe")
  assert string.contains(erlang_process_ffi, "windows-job-v3-20260831.exe")
