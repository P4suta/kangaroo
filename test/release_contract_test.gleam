...
pub fn runtime_and_ffi_contracts_are_cross_platform_safe_test() {
  ...
  assert string.contains(windows_job, "windows-job-v5-20260831.exe")
  assert string.contains(windows_job, "windows-job-v5-20260831.cmd")
  assert string.contains(windows_job, "/D /Q /C $launcherName")
  assert string.contains(windows_job_bridge, "windows-job-v5-20260831.exe")
